...
public static class ClassesMenu
{
    ...
    private static void ShowMenu()
    {
        ...
        menu.Add((1, "Class Test"));

        Printer.PrintMenuTitle("Classes", ConsoleTheme.TitleColor);
    ...
    private static void ExecuteCodeByOption(int optionNumber)
    {
        ...
        {
            case 0:
                Printer.PrintMenuTitle("Class Test", ConsoleTheme.SubtitleColor);
                ClassTest.Execute();
                break;
            case 1:
                Printer.PrintMenuTitle("Class Test", ConsoleTheme.SubtitleColor);
